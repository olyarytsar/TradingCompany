...
namespace TradingCompany.WPF
{
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if (result == true)
            {
                var mainWindow = Services.GetRequiredService<WarehouseManagerWindow>();
        ...
        private static IServiceProvider BuildServiceProvider()
        {
            ...
            {
                cfg.CreateMap<TradingCompany.DALEF.Models.Role, Role>()
                ...
                cfg.CreateMap<TradingCompany.DALEF.Models.Category, Category>()
            ...
            services.AddTransient<WarehouseManagerWindow>();
